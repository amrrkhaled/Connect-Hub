...
public class CommentNotifications implements ICommentNotifications{
    private final ILoadNotifications loadNotifications;
    private final String FILEPATH = "data/commentNotifications.json";
    public CommentNotifications(ILoadNotifications loadNotifications) {
    ...
    public void createNotifications(String userId, String contentId,String timestamp){
        ...
        JSONArray notifications = loadNotifications.LoadNotification(FILEPATH);
        newNotification.put("notificationId", "NC" + (notifications.length() + 1));
