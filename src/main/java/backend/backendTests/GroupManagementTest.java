...
public class GroupManagementTest {
        public static void main(String[] args) {
                ...
                PrimaryAdminController primaryAdminController = new PrimaryAdminController(loadGroups, storageHandler);
                Request requestController = new Request(loadGroups, storageHandler);

                // Simulating group creation
                System.out.println("Creating group...");
                groupManager.createGroup("admin1", "Group 1", "This is a test group", "images/I18.jpg");
                ...
                updatedImages.add("images/I18.jpg");
